...
const Home = ({ onExplore }) => (
  <div className="min-h-screen flex items-center justify-center p-6 home-bg">
    <div className="card text-center fade-in">
      ...
      <button onClick={onExplore} className="btn w-full transform hover:scale-105 duration-300">Explorar</button>
    </div>
  </div>
);
